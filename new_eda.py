...
def _():
    ...
    data_file = mne.io.read_raw_brainvision(r".\\FK23\DMI FK Jan to Feb 2024 OSF copy\\EEG DMI FK 1 21 2024 1114 Day 4.vhdr",preload=True)
    ...
    # Fake Fruition
    fake_fruition_start_time, fake_fruition_end_time, data = get_eeg_section(data_file, 26, 55, 27, 35)
    
    real_fruition_start_time, END_TIME, data = get_eeg_section(data_file, 29, 33, 33, 35)
    return (
        END_TIME,
        data,
        data_file,
